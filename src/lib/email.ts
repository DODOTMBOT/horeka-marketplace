...
const FROM = process.env.SMTP_FROM ?? `Unit One <${process.env.SMTP_USER}>`
...
<body style="margin:0;padding:0;background:#f7f8fc;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif">
  <div style="max-width:560px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #eaecf2">
    <div style="background:#f97316;padding:24px 32px">
      <p style="margin:0;color:#fff;font-size:18px;font-weight:800;letter-spacing:-0.3px">Unit One</p>
    </div>
    ...
    <div style="padding:20px 32px;border-top:1px solid #eaecf2">
      <p style="margin:0;font-size:12px;color:#8b92a5">Вы получили это письмо, так как зарегистрированы на Unit One</p>
    </div>
  </div>
</body>
</html>`
